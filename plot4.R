...
with(f_content,{
  plot(f_content$Time,as.numeric(as.character(f_content$Global_active_power)),type="l",  xlab="",ylab="Global Active Power")  
  plot(f_content$Time,as.numeric(as.character(f_content$Voltage)), type="l",xlab="datetime",ylab="Voltage")
  ...
  plot(f_content$Time,as.numeric(as.character(f_content$Global_reactive_power)),type="l",xlab="datetime",ylab="Global_reactive_power")
})
